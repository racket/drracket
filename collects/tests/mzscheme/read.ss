...
(error-test '(readstr ")") (readerrtype exn:read:paren?))
(error-test '(readstr "[)") (readerrtype exn:read:paren?))
(error-test '(readstr "[}") (readerrtype exn:read:paren?))
(error-test '(readstr "8 )") (readerrtype exn:read:paren?))
(error-test '(readstr "(8 . )") (readerrtype exn:read:paren?))
...
(let loop ([l number-table])
  (unless (null? l)
	  (let* ([pair (car l)]
		 ...
		 [s (cadr pair)])
	    (cond
	     [(eq? v 'X) (error-test `(readstr ,s) (readerrtype exn:read:number?))]
	     [v (test v readstr s)]
	     [else (test (string->symbol s) readstr s)]))
	  (loop (cdr l))))

(error-test '(readstr "#\\silly") (readerrtype exn:read:char?))
(error-test '(readstr "#\\nully") (readerrtype exn:read:char?))
(error-test '(readstr "#\\nu") (readerrtype exn:read:char?))
(error-test '(readstr "#\\733") (readerrtype exn:read:char?))
(error-test '(readstr "#\\433") (readerrtype exn:read:char?))
...
(error-test '(readstr ".") (readerrtype exn:read:dot?))
(error-test '(readstr "a .") (readerrtype exn:read:dot?))
(error-test '(readstr "a . b") (readerrtype exn:read:dot?))
(error-test '(readstr "( . )") (readerrtype exn:read:dot?))
(error-test '(readstr "( . 8)") (readerrtype exn:read:dot?))
(error-test '(readstr "(0 . 8 9)") (readerrtype exn:read:dot?))
(error-test '(readstr "( . 8 9)") (readerrtype exn:read:dot?))
(error-test '(readstr "#(8 . )") (readerrtype exn:read:dot?))
(error-test '(readstr "#( . )") (readerrtype exn:read:dot?))
(error-test '(readstr "#( . 8)") (readerrtype exn:read:dot?))
(error-test '(readstr "#(0 . 8 9)") (readerrtype exn:read:dot?))
...
(error-test '(readstr "#Q") (readerrtype exn:read:unsupported?))
...
(error-test '(readstr "#2(1 2 3)") (readerrtype exn:read:vector-length?))
...
(error-test '(readstr "#0#") (readerrtype exn:read:graph?))
(error-test '(readstr "#0=#0#") (readerrtype exn:read:graph?))
(error-test '(readstr "(#0# #0=7)") (readerrtype exn:read:graph?))
(error-test '(readstr "(#0=7 #1#)") (readerrtype exn:read:graph?))
(error-test '(readstr "#012345678=7") (readerrtype exn:read:graph?))
(error-test '(readstr "(#12345678=7 #012345678#)") (readerrtype exn:read:graph?))
