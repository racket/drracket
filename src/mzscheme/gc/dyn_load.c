...
{
  /* MATTHEW: I have no idea why this crashes for me. Since there
     are no collectable dynamic libraries in SunOS MzScheme/MrEd, 
     I just punt for SunOS4. */
#ifndef SUNOS4
