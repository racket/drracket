...
/* MATTHEW: Add RS6000 to this list for using generic: */
#     if defined(HP_PA) || defined(M88K) || defined(POWERPC) || (defined(I386) && (defined(OS2) || defined(USE_GENERIC))) || defined(UTS4) || defined(RS6000)
	/* Generic code                          */
