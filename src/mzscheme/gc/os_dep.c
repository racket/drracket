...
#     undef __KERNEL__
#   elif (LINUX_VERSION_CODE < 0x20020) /* MATTHEW: was 0x20100 */
...
#  if !defined(PCR) && !defined(AMIGA) && !defined(MSWIN32) \
      && !defined(MACOS) && !defined(DJGPP) && !defined(RS6000)
...
{
#if defined(sun)
  /* MATTHEW: My SunOS man page says not use to sbrk() with malloc().
     Xt definitely breaks if I use sbrk. */
  ptr_t mem;
